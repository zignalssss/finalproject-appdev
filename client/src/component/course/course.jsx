...
export default function Card({ course_id, altname, courseName, pg, img, point, usercourse,userpoint }) {
                ...
                <div className="card-actions justify-end mb-2">
                    {!isEnrolled ? (
                        ...
                        <div className="modal-box rounded-3xl bg-zinc-600 bg-opacity-60 shadow-5xl border-white border-t-2 border-l-2 border-opacity-20 backdrop-filter backdrop-blur-sm">
                            <h3 className="font-bold text-lg">Enroll Successfuly!</h3>
                            <p className="py-4">ขอบคุณสำหรับการลงทะเบียน!</p>
                        ...
                        <div className="modal-box rounded-3xl bg-zinc-600 bg-opacity-60 shadow-5xl border-white border-t-2 border-l-2 border-opacity-20 backdrop-filter backdrop-blur-sm">
                            ...
                            <p className="py-4">Point ของคุณไม่เพียงพอ</p>
                            <div className="modal-action">
                            <form method="dialog">
                                {/* if there is a button in form, it will close the modal */}
                                <button className="btn">Close</button>
